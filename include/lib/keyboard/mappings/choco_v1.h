...
RULES_FOR_SIMPLE_KEY(KEY02, KEY_CAPSLOCK);
...
RULES_FOR_KEY(KEY41) = {
    RULE(LAYER1, KEY_SQBRACKETL_CURBRACEL),
    RULE(LAYER0, KEY_F),
};
RULES_FOR_KEY(KEY42) = {
    RULE(LAYER1, KEY_MINUS_UNDERSCORE),
    RULE(LAYER0, KEY_V),
};
...
RULES_FOR_KEY(KEY51) = {
    RULE(LAYER1, KEY_SQBRACKETR_CURBRACER),
    RULE(LAYER0, KEY_G),
};
RULES_FOR_KEY(KEY52) = {
    RULE(LAYER0, KEY_B),
