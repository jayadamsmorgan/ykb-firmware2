...
DEFAULT_MAPPINGS_DEFINE = {
    ...
    LEFT_MAPPINGS(KEY50, KEY51, KEY52, KEY63, KEY62, KEY61, KEY60, KEY40, KEY41,
                  KEY42, KEY30, KEY31, KEY32, KEY20, KEY21, KEY22, KEY10, KEY11,
                  KEY12, KEY00, KEY01, KEY02, KEY50_LAYER_1, KEY51_LAYER_1,
                  KEY52_LAYER_1, KEY63_LAYER_1, KEY62_LAYER_1, KEY61_LAYER_1,
                  KEY60_LAYER_1, KEY40_LAYER_1, KEY41_LAYER_1, KEY42_LAYER_1,
                  KEY30_LAYER_1, KEY31_LAYER_1, KEY32_LAYER_1, KEY20_LAYER_1,
                  KEY21_LAYER_1, KEY22_LAYER_1, KEY10_LAYER_1, KEY11_LAYER_1,
                  KEY12_LAYER_1, KEY00_LAYER_1, KEY01_LAYER_1, KEY02_LAYER_1, )

        RIGHT_MAPPINGS(
            KEY80, KEY81, KEY82, KEY70, KEY71, KEY72, KEY73, KEY90, KEY91,
            KEY92, KEY100, KEY101, KEY102, KEY110, KEY111, KEY112, KEY120,
            KEY121, KEY122, KEY130, KEY131, KEY132, KEY80_LAYER_1,
            KEY81_LAYER_1, KEY82_LAYER_1, KEY70_LAYER_1, KEY71_LAYER_1,
            KEY72_LAYER_1, KEY73, KEY90_LAYER_1, KEY91_LAYER_1, KEY92_LAYER_1,
            KEY100_LAYER_1, KEY101_LAYER_1, KEY102_LAYER_1, KEY110_LAYER_1,
            KEY111_LAYER_1, KEY112_LAYER_1, KEY120_LAYER_1, KEY121_LAYER_1,
            KEY122_LAYER_1, KEY130_LAYER_1, KEY131_LAYER_1, KEY132_LAYER_1, )
