...
static inline void on_press(uint8_t *mappings, uint16_t key_index,
                            kb_settings_t *settings) {
...
static inline void on_release(uint8_t *mappings, uint16_t key_index,
                              kb_settings_t *settings) {
...
static inline void handle_bl_on_event(uint8_t key_index,
                                      kb_settings_t *settings, bool pressed,
                                      uint16_t *values) {
...
static inline void clear_hid_report() {
    memset(report, 0, 8);
    report_size = 0;
}

static inline void
build_hid_report_from_bitmap(uint8_t *mappings, kb_settings_t *settings,
...
static inline void handle_hid_report() {
