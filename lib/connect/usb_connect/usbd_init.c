...
#define CONFIG_YKB_USBD_PRODUCT_FULL CONFIG_YKB_USBD_PRODUCT " (Left)"
#elif CONFIG_YKB_RIGHT
#define CONFIG_YKB_USBD_PID CONFIG_YKB_USBD_PID_LEFT + 1
#define CONFIG_YKB_USBD_PRODUCT_FULL CONFIG_YKB_USBD_PRODUCT " (Right)"
...
USBD_DESC_PRODUCT_DEFINE(product, CONFIG_YKB_USBD_PRODUCT_FULL);
